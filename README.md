...
ESM2 pseudo-perplexity scores were calculated using the[esm2_pppl_calculator.py] on a GPU-enable AWS EC2 instance with the following specifications to ensure full reproducibility:
