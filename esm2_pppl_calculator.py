#!/usr/bin/env python3
"""
Optimized script to calculate both standard perplexity and pseudo perplexity scores for protein sequences using ESM-2.
This version includes several optimizations to speed up computation.
"""
